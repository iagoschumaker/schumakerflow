                        ...
                        <form onSubmit={handleCreateContract}>
                            <div className="modal-body">
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: editingContract ? '1fr 1fr 1fr' : '1fr 1fr', gap: 'var(--space-3)' }}>
                                    <div className="form-group"><label className="form-label">Data do 1º Vencimento</label><input className="form-input" type="date" value={contractForm.startDate} onChange={e => setContractForm({ ...contractForm, startDate: e.target.value })} required /><span style={{ fontSize: '0.65rem', color: 'var(--color-text-muted)', marginTop: 2, display: 'block' }}>Define quando será gerada a primeira fatura</span></div>
