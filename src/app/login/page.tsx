            ...
            <div className="login-split">
                ...
                <div className="login-split-banner">
                    <div className="login-banner-overlay">
                        ...
                        <div style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.6)', fontWeight: 400, maxWidth: 280, lineHeight: 1.5, textAlign: 'center' }}>Gestão de Clientes, Mídia, Agenda e Financeiro</div>
                    </div>
                </div>
